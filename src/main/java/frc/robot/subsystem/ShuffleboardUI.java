...
public class ShuffleboardUI extends SubsystemBase{
    ...
    public ShuffleboardUI(Swerve swerve) {
        ...
        //Test chooser
        {
            ...
            testChooser.addOption("Rotate module to zero", () -> new RotateToZero(swerve, () -> moduleChooser.getSelected()));
        }
        ...
        //Module state
        {
            ...
            moduleCurrentState.addDouble("Steer Target", ()-> currState.steerTarget);
